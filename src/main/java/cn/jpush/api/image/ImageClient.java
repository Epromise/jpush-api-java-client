...
public class ImageClient {
    ...
    public ImageUploadResult uploadImage(ImageFilePayload imageFilePayload) {
        ...
        checkImageUrlPayload(imageFilePayload);
        NativeHttpClient client = (NativeHttpClient) _httpClient;
    ...
    private void checkImageUrlPayload(ImageUrlPayload imageUrlPayload) {
        boolean anyUrlNotNull = imageUrlPayload.getImageUrl() != null
                || imageUrlPayload.getFcmImageUrl() != null
                || imageUrlPayload.getHuaweiImageUrl() != null
                || imageUrlPayload.getOppoImageUrl() != null
                || imageUrlPayload.getXiaomiImageUrl() != null
                || imageUrlPayload.getJiguangImageUrl() != null;
        Preconditions.checkArgument(anyUrlNotNull, "Require at least 1 non-null url");
    }

    private void checkImageUrlPayload(ImageFilePayload imageFilePayload) {
        boolean anyFileNotNull = imageFilePayload.getOppoFileName() != null
                || imageFilePayload.getXiaomiFileName() != null;
        Preconditions.checkArgument(anyFileNotNull, "Require at least 1 non-null fileName. Currently only support Xiaomi and OPPO");
    }
